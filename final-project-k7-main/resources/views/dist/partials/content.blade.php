  ...
  <div class="pcoded-content">
              ...
              <div class="row align-items-center">
                  <div class="col-md-12">
                      <div class="page-header-title">
                          <h5 class="m-b-10">Question Forum</h5>
                      </div>
                      {{-- <ul class="breadcrumb">
      ...
      {{-- <div class="row">
                              ...
                              <tbody>
                                  <tr>
                                      <td>
                                          ...
                                          <div class="d-inline-block align-middle">
                                              <img src="{{asset('./template/images/user/avatar-4.jpg')}}" alt="user image" class="img-radius wid-40 align-top m-r-15">
                                  ...
                                  <tr>
                                      <td>
                                          ...
                                          <div class="d-inline-block align-middle">
                                              <img src="{{asset('./template/images/user/avatar-2.jpg')}}" alt="user image" class="img-radius wid-40 align-top m-r-15">
                                              <div class="d-inline-block">
                                  ...
                                  <tr>
                                      <td>
                                          ...
                                          <div class="d-inline-block align-middle">
                                              <img src="{{asset('./template/images/user/avatar-3.jpg')}}" alt="user image" class="img-radius wid-40 align-top m-r-15">
                                              <div class="d-inline-block">
                                                  <h6>William Jem</h6>
          ...
          <div class="container mt-4">
            <div class="row">
                <div class="col-md-12">
                    <!-- Question form with user photo inside the border -->
                    <div class="card custom-card" style="border-radius: 20px;">
                        <div class="card-body">
                            <div class="media">
                                <!-- User's photo inside the border -->
                                <img src="user-photo.jpg" alt="User Photo" class="user-photo mr-3" style="width: 40px; height: 40px; border-radius: 50%; object-fit: cover; border: 2px solid black;">
                                <div class="media-body">
                                    <h5 class="card-title mb-0">Ask a Question</h5>
                                    <form enctype="multipart/form-data" method="POST" action="/post">
                                        @csrf
                                        <!-- Logo image for uploading a photo -->
                                        <label for="user-photo-upload" style="cursor: pointer;">
                                            <img src="upload-icon.png" alt="Upload Icon" style="width: 40px; height: 40px;">
                                            <input type="file" class="form-control-file" id="user-photo-upload" name="image" style="display: none;">
                                        </label>
                                        <div class="form-group">
                                            <textarea class="form-control" rows="3" placeholder="What's your question?" name="content"></textarea>
                                        </div>
                      ...
                      <div class="review-block">
                          <div class="row">
                              <div class="col-sm-auto p-r-0">
                                  <img src="{{asset('./template/images/user/avatar-2.jpg')}}" alt="user image" class="img-radius profile-img cust-img m-b-15">
                              </div>
                              <div class="col">
                          ...
                          <div class="row">
                              <div class="col-sm-auto p-r-0">
                                  <img src="{{asset('./template/images/user/avatar-4.jpg')}}" alt="user image" class="img-radius profile-img cust-img m-b-15">
                              </div>
                              <div class="col">
                  ...
                  <div class="card-body">
                      <div class="row m-b-20 received-chat">
                          <div class="col-auto p-r-0">
                              <img src="{{asset('./template/images/user/avatar-2.jpg')}}" alt="user image" class="img-radius wid-40">
                          </div>
                          <div class="col">
                              <div class="msg">
                      ...
                      <div class="row m-b-20 send-chat">
                          ...
                          <div class="col-auto p-l-0">
                              <img src="{{asset('./template/images/user/avatar-3.jpg')}}" alt="user image" class="img-radius wid-40">
                          </div>
                      </div>
                      <div class="row m-b-20 received-chat">
                          <div class="col-auto p-r-0">
                          ...
                          <div class="col">
                              <div class="msg">
                                  <p class="m-b-0">Nice to meet you!</p>
                                  <img src="{{asset('./template/images/widget/dashborad-1.jpg')}}" alt="">
                                  <img src="{{asset('./template/images/widget/dashborad-3.jpg')}}" alt="">
                              </div>
                              <p class="text-muted m-b-0"><i class="fa fa-clock-o m-r-10"></i>10:20am</p>
                          </div>
                      </div>
