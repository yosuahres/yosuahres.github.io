<header class="navbar pcoded-header navbar-expand-lg navbar-light header-dark">
  ...
  <div class="m-header">
    ...
    <a href="#!" class="b-brand">
      ...
      <img src="{{asset('./template/images/logo.png')}}" alt="" class="logo">
      <img src="{{asset('./template/images/logo-icon.png')}}" alt="" class="logo-thumb">
    </a>
      ...
      <li class="nav-item">
        <div class="dropdown">
          ...
          <div class="dropdown-menu profile-notification ">
            <ul class="pro-body">
              <li><a href="/dist/layouts/user-profile" class="dropdown-item"><i class="fas fa-circle"></i> Profile</a></li>
              <li><a href="/dist/layouts/email_inbox" class="dropdown-item"><i class="fas fa-circle"></i> My Messages</a></li>
              <li><a href="/dist/layouts/auth-signin" class="dropdown-item"><i class="fas fa-circle"></i> Lock Screen</a></li>
            </ul>
          </div>
        </div>
      </li>
          ...
          <div class="dropdown-menu dropdown-menu-right notification">
            ...
            <ul class="noti-body">
              ...
              <li class="notification">
                <div class="media">
                  <img class="img-radius" src="{{asset('./template/images/user/avatar-1.jpg')}}" alt="Generic placeholder image">
              ...
              <li class="notification">
                <div class="media">
                  <img class="img-radius" src="{{asset('./template/images/user/avatar-2.jpg')}}" alt="Generic placeholder image">
                  <div class="media-body">
      ...
      <li>
        <div class="dropdown drp-user">
          ...
          <div class="dropdown-menu dropdown-menu-right profile-notification">
            <div class="pro-head">
              <img src="{{asset('./template/images/user/avatar-1.jpg')}}" class="img-radius" alt="User-Profile-Image">
              <span>John Doe</span>
              <a href="/dist/layouts/auth-signin" class="dud-logout" title="Logout">
                <i class="feather icon-log-out"></i>
              </a>
            </div>
            <ul class="pro-body">
              <li><a href="/dist/layouts/user-profile" class="dropdown-item"><i class="feather icon-user"></i> Profile</a></li>
              <li><a href="/dist/layouts/email_inbox" class="dropdown-item"><i class="feather icon-mail"></i> My Messages</a></li>
              <li><a href="/dist/layouts/auth-signin" class="dropdown-item"><i class="feather icon-lock"></i> Lock Screen</a></li>
            </ul>
          </div>
        </div>
      </li>
